    ...
    <>
      <div className="fixed inset-0 pointer-events-none z-0">
        {MONEY_ITEMS.map((item, i) => (
          <div
            key={i}
            className="money-fall hidden sm:block"
            style={{
              left: item.left,
              fontSize: item.size,
      ...
      <main className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-slate-800 to-gray-900 relative z-10">
